...
public class TestHttpShardHandlerFactory extends SolrTestCaseJ4 {
  ...
  public void testLoadBalancerRequestsMinMax() throws Exception {
    ...
    try {
      cc = CoreContainer.createAndLoad(home.toString(), home.resolve("solr-shardhandler-loadBalancerRequests.xml").toFile());
      ...
      // create LBHttpSolrServer request
      final LBHttpSolrServer.Req req = httpShardHandlerFactory.newLBHttpSolrServerReq(queryRequest, urls);
